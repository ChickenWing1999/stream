document.addEventListener("DOMContentLoaded", () => {
    ...
    watchButton.addEventListener("click", () => {
        ...
        if (liveStreamId) {
            ...
            streamContainer.innerHTML = `<iframe src="https://1stream.eu/game/${liveStreamId}" width="100%" height="540" marginheight="0" marginwidth="0" scrolling="no" frameborder="0" allowfullscreen="yes"  allow="encrypted-media"></iframe>`;
    ...
    function getLiveStreamId(game) {
        ...
        const gameStreamMap = {
            game1: "puerto-rico-south-sudan-live-stream/681951?embed=1",
            game2: "georgia-cape-verde-live-stream/681955?embed=1",
            game3: "greece-jordan-live-stream/681953?embed=1",
            game4: "brazil-iran-live-stream/681957?embed=1",
