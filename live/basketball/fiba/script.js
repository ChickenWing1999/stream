document.addEventListener("DOMContentLoaded", () => {
    ...
    watchButton.addEventListener("click", () => {
        ...
        if (liveStreamId) {
            ...
            streamContainer.innerHTML = `<iframe src="https://1stream.eu/game/${liveStreamId}" width="700" height="540" marginheight="0" marginwidth="0" scrolling="no" frameborder="0" allowfullscreen="yes"  allow="encrypted-media"></iframe>`;
