document.addEventListener("DOMContentLoaded", () => {
    ...
    watchButton.addEventListener("click", () => {
        ...
        if (liveStreamId) {
            ...
            streamContainer.innerHTML = `<iframe src="${liveStreamId}" width="100%" height="500px" marginheight="0" marginwidth="0" scrolling="no" frameborder="0" allowfullscreen  allow="encrypted-media"></iframe>`;
