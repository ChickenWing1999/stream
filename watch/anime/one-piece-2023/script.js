document.addEventListener("DOMContentLoaded", () => {
    ...
    watchButton.addEventListener("click", () => {
        ...
        if (liveStreamId) {
            ...
            streamContainer.innerHTML = `<iframe src="${liveStreamId}" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe>`;
    ...
    function getLiveStreamId(game) {
        ...
        const gameStreamMap = {
            game1: "https://media.cm/e/ua192g4a0uh2",
            game2: "https://1stream.eu/game/china-angola-live-stream/688005?embed=1",
            game3: "https://1stream.eu/game/mexico-new-zealand-live-stream/688049?embed=1",
